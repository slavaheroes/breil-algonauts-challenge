...
parent_submission_dir = '/SSD/slava/algonauts/algonauts_2023_challenge_submission_clip_large_text_n_image'
...
def load_dataset(subj, mode):
    ...
    image_features_dir = os.path.join("/SSD/slava/algonauts/clip_large_features", f'subj0{subj}', mode)
    text_features_dir = os.path.join("/SSD/slava/algonauts/clip_large_text_features", f'subj0{subj}', mode)
